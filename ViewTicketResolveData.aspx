<%@ Page Title="Ticket Raised Details" Language="C#" MasterPageFile="~/view/Main.Master" AutoEventWireup="true" CodeBehind="ViewTicketResolveData.aspx.cs" Inherits="ServiceDesk.view.ViewTicketResolveData" %>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Action">
                                            <ItemTemplate>
                                                ...
                                                <asp:LinkButton ID="LnkEditRequest" runat="server" Text="Preview"></asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
